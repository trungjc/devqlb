	...
	function ajax_render_location( $options = array() )
	{
		...
		switch($options['param'])
		{
			...
			case "post_status" :
				...
				$choices = array(
					'publish'	=> __( 'Publish','quickloans_theme' ),
					'pending'	=> __( 'Pending Review','quickloans_theme' ),
					'draft'		=> __( 'Draft','quickloans_theme' ),
					'future'	=> __( 'Future','quickloans_theme' ),
					'private'	=> __( 'Private','quickloans_theme' ),
					'inherit'	=> __( 'Revision','quickloans_theme' ),
					'trash'		=> __( 'Trash','quickloans_theme' )
				);
			...
			case "user_type" :
				...
				if( is_multisite() )
				{
					$choices['super_admin'] = __('Super Admin','quickloans_theme');
				}
